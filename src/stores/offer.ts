    ...
    hotels: [
      {
        ...
        currency: 'RUB',
        gallery: [
          { url: '/src/assets/images/examples/hotel_1.jpeg',},
          { url: '/src/assets/images/examples/hotel_2.jpeg',},
        ],
        serviceFee: 0,
        checkIn: '2025-11-06',
        checkOut: '2025-11-13',
      ...
      },
      {
        ...
        gallery: [
          { url: '/src/assets/images/examples/hotel_2.jpeg',},
          { url: '/src/assets/images/examples/hotel_3.jpeg',},
        ],
        serviceFee: 15000,
        serviceFeeCurrency: 'RUB',
        checkIn: '2025-11-13',
    ...
    excursions: [
      {
        ...
        gallery: [
          { url: '/src/assets/images/examples/exc_8.jpeg',},
          { url: '/src/assets/images/examples/exc_9.jpeg',},
        ],
      },
      {
        date: new Date('2025-11-10'),
        city: 'Никко',
        name: 'День-поездка в Никко',
        price: 14200,
        currency: 'RUB',
        managerComment: 'День-поездка в Никко: святилище Тосёгу, водопад Кэгон. Трансфер включён.',
        gallery: [
          { url: '/src/assets/images/examples/exc_10.jpeg',},
          { url: '/src/assets/images/examples/exc_5.jpeg',},
        ],
      },
      {
        ...
        city: 'Киото',
        price: 16800,
        name: 'Золотой павильон, Арасияма, бамбуковая роща, чайная церемония.',
        currency: 'RUB',
    ...
    cruises: [
      {
        ...
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
    ...
    excursions: [
      {
        ...
        city: 'Барселона',
        name: 'Пешая экскурсия по Готическому кварталу и Саграда Фамилия',
        price: 11500,
        currency: 'RUB',
    ...
    excursions: [
      {
        ...
        city: 'Масаи-Мара',
        name: 'Полёт на воздушном шаре над саванной',
        price: 28500,
        currency: 'RUB',
    ...
    excursions: [
      {
        ...
        city: 'Париж',
        price: 8500,
        name: 'Обзорная экскурсия: Нотр-Дам, Лувр, Елисейские поля. Русскоязычный гид.',
        currency: 'RUB',
      ...
      },
      {
        ...
        name: 'Дворец и парк Версаля: дворцовые залы, Большой Трианон, Малый Трианон.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
      },
      {
        ...
        name: 'Ужин на борту прогулочного катера по Сене с видом на Эйфелеву башню.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
    ...
    excursions: [
      {
        ...
        name: 'Храмы Бангкока: Ват Пхо, Изумрудный Будда, Большой дворец. Лодочная прогулка.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
      },
      {
        ...
        name: 'Морская прогулка на яхте вокруг острова с остановкой на коралловом рифе, снорклинг.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
    ...
    excursions: [
      {
        ...
        name: 'Колизей (арена), Римский форум, Капитолийские музеи. Приоритетный вход.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
      },
      {
        ...
        name: 'Прогулка на гондоле по каналам, посещение мастерской стеклодувов на Мурано.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
    ...
    excursions: [
      {
        ...
        name: 'Тур "Золотое кольцо": гейзер Гейсир, водопад Гюдльфосс, Тингвеллир.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
      },
      {
        ...
        name: 'Ледниковая пещера в Ватнайокутле + охота на северное сияние вечером.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
    ...
    excursions: [
      {
        ...
        name: 'Обзорная экскурсия: Хумаюнова гробница, Кутб-Минар, Красный форт, Старый Дели.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
      },
      {
        ...
        name: 'Тадж-Махал на рассвете + Агрский форт. Приоритетный вход.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
      },
      {
        ...
        name: 'Джайпур: форт Амбер на слонах, Хава-Махал, Джантар-Мантар, базар.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
    ...
    excursions: [
      {
        ...
        name: 'Вечерний тур-танго: урок с мастером + шоу-ужин в легендарной Milonga.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
      },
      {
        ...
        name: 'Треккинг по леднику Перито-Морено с ледоходами + переправа на лодке.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
    ...
    excursions: [
      {
        ...
        name: 'Обзор Сиднея: Опера (экскурсия внутри), Харбор-Бридж (пешеходная прогулка по мосту), Бонди-бич.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
      },
      {
        ...
        name: 'День-поездка в Голубые горы: Три сестры, эвкалиптовые леса, Scenic World.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
    ...
    excursions: [
      {
        ...
        name: 'Пешая экскурсия: Пражский Град, Карлов мост, Старый город, Астрономические часы.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
      },
      {
        ...
        name: 'Обзор Вены: Шёнбрунн, Бельведер, Хофбург, Ринг. Вечерний концерт Моцарта.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
    ...
    excursions: [
      {
        ...
        city: 'Ванкувер',
        price: 14200,
        name: 'Обзорная экскурсия: парк Стэнли, Гастаун, Грандвил-Айленд, подвесной мост Капилано.',
        currency: 'RUB',
      ...
      },
      {
        ...
        name: 'Каноэ на озере Луиз + поход на смотровую площадку Plain of Six Glaciers. Гид-натуралист.',
        gallery: [
          { url: '/src/assets/images/examples/exc_1.jpeg',},
          { url: '/src/assets/images/examples/exc_4.jpeg',},
        ],
